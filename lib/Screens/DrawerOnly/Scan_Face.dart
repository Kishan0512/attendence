...
class Scan_Face extends StatefulWidget {
  @override
  _Scan_FaceState createState() => _Scan_FaceState();
}

class _Scan_FaceState extends State<Scan_Face> {
  late File jsonFile;
              ...
              onTap: () async {
                if (_faceFound) {
                  ...
                  CustomWidgets.showToast(
                      context, "Scan Completed successfully", true);
                } else {
                  showDialog(
                    context: context,
                    builder: (context) {
