...
class _DropdownOverlayState extends State<_DropdownOverlay> {
  ...
  Widget build(BuildContext context) {
    ...
    // list padding
    final listPadding =
        onSearch ? const EdgeInsets.only(top: 8,right: 10,left: 10) : EdgeInsets.zero;
    ...
    final child = Stack(alignment: Alignment.center,
      children: [
        Positioned(
            ...
            child: Container(
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  ...
                  border: Border.all(width: 1,color: Colorr.themcolor),
                  boxShadow: [
                    BoxShadow(
                      blurRadius: 24.0,
